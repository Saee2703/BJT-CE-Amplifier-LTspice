...
A BC847B NPN transistor configured as a common emitter amplifier with voltage divider biasing network — designed and verified in LTspice XVII using transient analysis.
